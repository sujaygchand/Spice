	...
	public class RegisterModel : PageModel
	{
		...
		public async Task<IActionResult> OnPostAsync(string returnUrl = null)
		{
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					await CreateRoleIfNotValid(StaticDetails.ManagerUser);
					await CreateRoleIfNotValid(StaticDetails.CustomerEndUser);
		...
		private async Task CreateRoleIfNotValid(string roleName)
		{
